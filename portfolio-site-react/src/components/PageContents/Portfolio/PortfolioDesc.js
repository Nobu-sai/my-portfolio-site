          ...
          <div className="explanation">
            <div className="user_story">
              <div className="user_story__heading">User Story:</div> 
                <div className="user_story__text"><span class="yellow_marker">{portfolioToShow.user_story}</span></div>
            </div>
            <div className="dev_story">
              <div className="dev_story__heading">Dev Story:</div> 
              <div className="dev_story__text"><span class="yellow_marker">{portfolioToShow.dev_story}</span></div>
            </div>
          </div> 
